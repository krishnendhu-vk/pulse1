...
def build_summary():
    ...
    weather = get_weather()
    quote = get_quote()  # Added missing '=' sign here
...
TODAY'S QUOTE
    {quote}
============================="""  # Cleaned up the formatting strings here
    return summary 

def run():
    """Main entry point. Called by GitHub Actions."""
    summary = build_summary()  # Added missing '=' sign here
...
if __name__ == "__main__":  # Fixed typos in double underscores and condition
    run()
